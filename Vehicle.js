...
class Vehicle {
  ...
  class AgentVehicle extends Vehicle {
    constructor(x, y, regions, name) {
      super(x, y);
      this.vel = p5.Vector.random2D();
      this.vel.mult(5);
      this.sensor = new Sensor(x,y,50)
      this.regions = regions; //this is an array
      this.maxSpeed = 2
      this.name = name;
    }
    ...
    update(){
        super.update()
        this.sensor.position = this.pos
        this.sensor.update(this.regions)
    }
    ...
    show() {
        ...
        triangle(-this.r, -this.r / 2, -this.r, this.r / 2, this.r, 0);
        stroke('green')
        line(-this.r, -this.r / 2, -this.r, this.r / 2, this.r, 0)
        line(this.r, 0, -this.r, -this.r / 2, -this.r, 0)
        line(this.r, 0, -this.r, this.r / 2, this.r, 0)
        pop();
      
        this.sensor.show()

        //seeing if this shows up in gi
    }
  }
